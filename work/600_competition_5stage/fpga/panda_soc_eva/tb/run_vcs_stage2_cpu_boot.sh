...
BUILD_DIR="$SCRIPT_DIR/sim_build_vcs_stage2_cpu_boot"
RTL_DIR="$SOC_DIR/rtl"
...
vlogan -full64 -sverilog \
  ...
  "$SCRIPT_DIR/tb_panda_soc_stage2_cpu_boot.sv"

vcs -full64 tb_panda_soc_stage2_cpu_boot -o simv_stage2_cpu_boot
./simv_stage2_cpu_boot
